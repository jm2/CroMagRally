...
- **Unreleased**
    ...
    - Scale the per-place catch-up and the POW respawn time to the number of cars, so twelve-car races play like six-car ones. Races with six cars or fewer are unchanged.
