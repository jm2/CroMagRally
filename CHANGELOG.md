...
- **Unreleased**
    ...
    - Give all twelve drivers distinct looks, and mark the second driver in each outfit colour on the minimap.
    ...
    - Scale the sound-channel, skid-mark and particle budgets with the player limit, and log once when every sound channel or particle group is in use.
    - Scoreboards are validated against the build's player limit: a six-player build discards 7th–12th place records written by a twelve-player build.
